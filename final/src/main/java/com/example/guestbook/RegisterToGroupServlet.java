...
public class RegisterToGroupServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
	GroupRegistration newGroupRegistration = new GroupRegistration();
    UserService userService = UserServiceFactory.getUserService();
    User user = userService.getCurrentUser();  // Find out who the user is.

    Student student; //add functionality to get the corresponding student here;
    
    String selectedGroup = req.getParameter("selectedGroup");
    

    //Create a registration object here
    ...
    resp.sendRedirect("/showGroup.jsp?groupName=" + selectedGroup);
  }
}
//[END all]
